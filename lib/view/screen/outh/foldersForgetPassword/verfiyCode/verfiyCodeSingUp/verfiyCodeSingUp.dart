...
import 'package:ecommerceapp21/view/screen/outh/foldersForgetPassword/verfiyCode/verfiyCodeSingUp/verFiyCodeSingup_Controller.dart';
...
class VerfiyCodeSingUp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(VerFiyCodeSingUpControllerImp());
    return GetBuilder<VerFiyCodeSingUpControllerImp>(
                    ...
                    child: Column(children: [
                      ...
                      OtpTextField(
                        ...
                        onSubmit: (String verificationCode) {
                          controller.gotopageSuccessSingUp(verificationCode);
